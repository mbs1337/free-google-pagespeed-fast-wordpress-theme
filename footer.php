        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="footer-links mb-3">
                    ...
                    <span>|</span>
                    <a href="<?php echo esc_url(home_url('/life/')); ?>">Life</a>
                </div>

                <div class="footer-copyright">
                    <p>🄯 All rights reversed. Steal freely 🙂<br /><?php bloginfo('name'); ?> · Demo theme</p>
                    <p>
                        Built with <span class="text-success"><svg width="28" height="28" viewBox="0 0 200 200">
