    ...
    <div class="container pb-0 mb-3">
        <?php while (have_posts()) : the_post(); ?>
            ...
            <div class="skills-intro mb-5 text-center py-4">
                <h1 class="hero-title mb-4">Demo <span class="highlight-gradient">Skills</span> Lorem Ipsum</h1>
                <p class="hero-lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<br /><br />Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            </div>
            ...
            <!-- Web Development -->
            <section class="skills-section skills-band">
                <div class="container">
                <h2 class="mb-5 pb-5 text-center"><i class="bi bi-code-slash"></i> Lorem ipsum</h2>
                <div class="skills-grid">
                    ...
                    <div class="skill-item">
                        <div class="skill-icon-box">
                            <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/rust-icon.png' ); ?>" alt="Rust">
                        </div>
                        <h3 class="h6 mt-3">Rust</h3>
                        <p class="skill-rating">★★☆☆☆</p>
                    </div>
                </div>
                </div>
            ...
            <!-- CMS & E-commerce -->
            <section class="skills-section skills-plain">
                <div class="container">
                <h2 class="mb-5 pb-5 text-center"><i class="bi bi-shop"></i> Dolor sit amet</h2>
                <div class="skills-grid">
                    <div class="skill-item">
                        <div class="skill-icon-box">
                    ...
                    <div class="skill-item">
                        <div class="skill-icon-box">
                            <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/e-studio-e-icon.png' ); ?>" alt="Custom Shop">
                        </div>
                        <h3 class="h6 mt-3">Custom Shop</h3>
                        <p class="skill-rating">★★★★☆</p>
                    </div>
            ...
            <section class="skills-section skills-band">
                <div class="container">
                <h2 class="mb-5 pb-5 text-center"><i class="bi bi-palette"></i> Consectetur elit</h2>
                <div class="skills-grid">
                    <div class="skill-item">
                        <div class="skill-icon-box">
            ...
            <section class="skills-section skills-plain">
                <div class="container">
                <h2 class="mb-5 pb-5 text-center"><i class="bi bi-tools"></i> Sed do eiusmod</h2>
                <div class="skills-grid">
                    <div class="skill-item">
                        <div class="skill-icon-box">
                            <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/nano-icon.png' ); ?>" alt="nano">
                        </div>
                        <h3 class="h6 mt-3">nano</h3>
                        <p class="skill-rating">★★★★★</p>
                    </div>
                    ...
                    <div class="skill-item">
                        <div class="skill-icon-box">
                            <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/zed-icon.png' ); ?>" alt="Zed">
                        </div>
                        <h3 class="h6 mt-3">Zed</h3>
                        <p class="skill-rating">★★★★☆</p>
                    </div>
                    ...
                    <div class="skill-item">
                        <div class="skill-icon-box">
                            <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/vim-icon.png' ); ?>" alt="Vim">
                        </div>
                        <h3 class="h6 mt-3">Vim</h3>
                        <p class="skill-rating">★★☆☆☆</p>
                    </div>
             ...
             <section class="skills-section skills-band">
                <div class="container">
                <h2 class="mb-5 pb-5 text-center"><i class="bi bi-robot"></i> Tempor incididunt</h2>
                <div class="skills-grid">
                    <div class="skill-item">
                        <div class="skill-icon-box">
                    ...
                    <div class="skill-item">
                        <div class="skill-icon-box">
                            <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/qwen-icon.png' ); ?>" alt="Qwen">
                        </div>
                        <h3 class="h6 mt-3">Qwen</h3>
                        <p class="skill-rating">★★☆☆☆</p>
                    </div>
            ...
            <section class="skills-section skills-plain">
                <div class="container">
                <h2 class="mb-5 pb-5 text-center"><i class="bi bi-server"></i> Ut labore magna</h2>
                <div class="skills-grid">
                    <div class="skill-item">
                        <div class="skill-icon-box">
                    ...
                    <div class="skill-item">
                        <div class="skill-icon-box">
                            <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/owncloud-icon.png' ); ?>" alt="ownCloud">
                        </div>
                        <h3 class="h6 mt-3">ownCloud</h3>
                        <p class="skill-rating">★★★★☆</p>
                    </div>

                    <div class="skill-item">
                        <div class="skill-icon-box">
                            <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/nextcloud-icon.png' ); ?>" alt="Nextcloud">
                        </div>
                        <h3 class="h6 mt-3">Nextcloud</h3>
                        <p class="skill-rating">★★★★☆</p>
                    </div>

                    <div class="skill-item">
                        <div class="skill-icon-box">
                            <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/synology-icon.png' ); ?>" alt="Synology">
                        </div>
                        <h3 class="h6 mt-3">Synology</h3>
                        <p class="skill-rating">★★★★☆</p>
                    </div>
            ...
            <section class="skills-section skills-band">
                <div class="container">
                <h2 class="mb-5 pb-5 text-center"><i class="bi bi-speedometer2"></i> Aliqua enim</h2>
                <div class="skills-grid">
                    <div class="skill-item">
                        <div class="skill-icon-box">
            ...
            <section class="skills-section skills-plain">
                <div class="container">
                <h2 class="mb-5 pb-5 text-center"><i class="bi bi-laptop"></i> Minim veniam</h2>
                <div class="skills-grid">
                ...
                <div class="skill-item">
                    ...
                    <div class="skill-item">
                        <div class="skill-icon-box">
                            <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/libreoffice-icon.png' ); ?>" alt="LibreOffice">
                        </div>
                        <h3 class="h6 mt-3">LibreOffice</h3>
                        <p class="skill-rating">★★★☆☆</p>
                    </div>
            ...
            <section class="skills-section skills-band">
                <div class="container">
                <h2 class="mb-5 pb-5 text-center"><i class="bi bi-book"></i> Quis nostrud</h2>
                <div class="skills-grid">
                    <div class="skill-item">
                        <div class="skill-icon-box">
