        ...
        <div class="container">
            <a class="navbar-brand" href="<?php echo esc_url(home_url('/')); ?>">
                <?php if (has_custom_logo()) : ?>
                    <?php the_custom_logo(); ?>
                <?php else : ?>
                    <span class="logo-aurora">Theme Name</span>
                <?php endif; ?>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
				...
				<div class="d-flex ms-3 dark-bg">
                    <?php if (is_user_logged_in()) : ?>
                        <a href="<?php echo esc_url(admin_url()); ?>" class="btn btn-secondary btn-custom-color btn-sm me-2">Dolor</a>
                        <a href="<?php echo esc_url(wp_logout_url(home_url())); ?>" class="btn btn-primary btn-sm">Sit Amet</a>
                    <?php else : ?>
						<a href="#" id="connect-link" class="btn btn-secondary btn-custom-color btn-sm me-2" rel="nofollow" aria-describedby="connect-popover" role="button">Lorem</a>
                        <a href="<?php echo esc_url(home_url('/skills/')); ?>" class="btn btn-primary btn-sm">Ipsum</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
